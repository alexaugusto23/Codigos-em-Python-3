...
class TestClientes(unittest.TestCase):
    ...
    def test_02_data_de_um_jogo(self):
        dados = pega_dados()
    ...
    def test_03_ids_dos_times_de_um_jogo(self):
        dados = pega_dados()
    ...
    def test_08_ids_de_jogos_de_um_time(self):
        dados = pega_dados()
    ...
    def test_09_datas_de_jogos_de_um_time(self):
        dados = pega_dados()
    ...
    def test_10_dicionario_de_gols(self):
        dados = pega_dados()
    ...
    def test_11_time_que_fez_mais_gols(self):
        dados = pega_dados()
    ...
    def test_12_dicionario_id_estadio_e_nro_jogos(self):
        dados = pega_dados()
    ...
    def test_13_qtos_libertadores(self):
        dados = pega_dados()
    ...
    def test_14_ids_dos_melhor_classificados(self):
        dados = pega_dados()
    ...
    def test_15_classificados_libertadores(self):
        dados = pega_dados()
    ...
    def test_17_classificacao_do_time_por_id(self):
        dados = pega_dados()
